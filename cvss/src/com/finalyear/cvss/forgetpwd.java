...
public class forgetpwd extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cpwd1);
		
		StrictMode.ThreadPolicy policy = new StrictMode.ThreadPolicy.Builder().permitAll().build();
		StrictMode.setThreadPolicy(policy);
	    newpwd = (EditText) findViewById(R.id.newpwd);
        change = (Button) findViewById(R.id.submit1);
        change.setOnClickListener(new View.OnClickListener() {
           public void onClick(View view) {
               ...
               String command="fpwd";
               String password;
               byte[] demoMesageBytes = newpw.getBytes();
               //shared secret
          ...
          //     System.out.println("Demo1 encrypted (base64): "+ new String(encode(demo1EncryptedBytes)));
               ...
               url="http://mobilelock.freeiz.com/test/change.php?&new="+password+"&command="+command+"&uname="+uname;
       		...
       		try {
       		    ...
       		    if(response != null) {
       		        ...
       		        //if(line.equals)
       		        Toast.makeText(forgetpwd.this, line, Toast.LENGTH_SHORT).show();
       		    } else {
       		        Toast.makeText(forgetpwd.this, "Unable to complete your request", Toast.LENGTH_LONG).show();
       		    }
       		} catch (ClientProtocolException e) {
       		    Toast.makeText(forgetpwd.this, "Caught ClientProtocolException", Toast.LENGTH_SHORT).show();
       		} catch (IOException e) {
       		    Toast.makeText(forgetpwd.this, "Caught IOException", Toast.LENGTH_SHORT).show();
       		} catch (Exception e) {
       		    Toast.makeText(forgetpwd.this, "Caught Exception", Toast.LENGTH_SHORT).show();
       		}
                   }
               });
       	...
       	private String convertStreamToString(InputStream is) {
       	    ...
       	    try {
       	        ...
       	        Toast.makeText(forgetpwd.this, "Stream Exception", Toast.LENGTH_SHORT).show();
       	    }
