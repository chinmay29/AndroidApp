...
public class CPwd extends Activity {
	String url;
	Button change;
	EditText oldpwd;
	EditText newpwd;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        change.setOnClickListener(new View.OnClickListener() {
           public void onClick(View view) {
               ...
               String newpw = newpwd.getText().toString();
               final String uname = getIntent().getStringExtra("username");
       		             
               String command="pwd";
               String oldpass,newpass;
               byte[] demoMesageBytes = oldpw.getBytes();
               byte[] demoMesageBytes1 = newpw.getBytes();
               //shared secret
               ...
               byte[] demo1EncryptedBytes1=null;
               
               try {
               demo1EncryptedBytes = demo1encrypt(demoKeyBytes, demoIVBytes, sPadding, demoMesageBytes);
               demo1EncryptedBytes1 = demo1encrypt(demoKeyBytes, demoIVBytes, sPadding, demoMesageBytes1);
          ...
          //     System.out.println("Demo1 encrypted (base64): "+ new String(encode(demo1EncryptedBytes)));
               ...
               oldpass=new String(encode(demo1EncryptedBytes));

               newpass=new String(encode(demo1EncryptedBytes1));
 
               url="http://mobilelock.freeiz.com/test/change.php?old="+oldpass+"&new="+newpass+"&command="+command+"&uname="+uname;
       		...
       		try {
       		    ...
       		    if(response != null) {
       		        ...
       		        //if(line.equals)
       		        Toast.makeText(CPwd.this, line, Toast.LENGTH_SHORT).show();
       		    } else {
       		        Toast.makeText(CPwd.this, "Unable to complete your request", Toast.LENGTH_LONG).show();
       		    }
       		} catch (ClientProtocolException e) {
       		    Toast.makeText(CPwd.this, "Caught ClientProtocolException", Toast.LENGTH_SHORT).show();
       		} catch (IOException e) {
       		    Toast.makeText(CPwd.this, "Caught IOException", Toast.LENGTH_SHORT).show();
       		} catch (Exception e) {
       		    Toast.makeText(CPwd.this, "Caught Exception", Toast.LENGTH_SHORT).show();
       		}
                   }
               });
       	...
       	private String convertStreamToString(InputStream is) {
       	    ...
       	    try {
       	        ...
       	        Toast.makeText(CPwd.this, "Stream Exception", Toast.LENGTH_SHORT).show();
       	    }
