...
public class Login extends Activity {
    ...
    */
	    ...
	    //     inputlock= (EditText) findViewById(R.id.lock);
	      ...
	      //          String lock = inputlock.getText().toString();
	        ...
	        /*        Calendar c = Calendar.getInstance();
	                ...
	                Toast.makeText(Login.this, formattedDate, Toast.LENGTH_SHORT); 
	                SimpleDateFormat df1 = new SimpleDateFormat("HH:mm:ss");
	                String formattedDate1 = df1.format(c.getTime());
	                Toast.makeText(Login.this, formattedDate1, Toast.LENGTH_SHORT);
	          */         
	                String password;
	           ...
	           //     System.out.println("Demo1 encrypted (base64): "+ new String(encode(demo1EncryptedBytes)));
	                ...
	                url="http://mobilelock.freeiz.com/test/signin.php?uname="+uname+"&pwd="+password+"&imei="+imei+"&command="+command;
	        		...
	        		try {
	        		    ...
	        		    if(response != null) {
	        		        ...
	        		        Toast.makeText(Login.this, "Unable to complete your request", Toast.LENGTH_LONG).show();
	        		    }
	        		} catch (ClientProtocolException e) {
	        		    Toast.makeText(Login.this, "Caught ClientProtocolException", Toast.LENGTH_SHORT).show();
	        		} catch (IOException e) {
	        		    Toast.makeText(Login.this, "Caught IOException", Toast.LENGTH_SHORT).show();
	        		} catch (Exception e) {
	        		    Toast.makeText(Login.this, "Caught Exception", Toast.LENGTH_SHORT).show();
	        		}
	                    }   });
	        forget.setOnClickListener(new View.OnClickListener() {
	        	 
	            public void onClick(View view) {
	            	Intent goToNextActivity = new Intent(getApplicationContext(), Forget.class);
	...
	private String convertStreamToString(InputStream is, String u) {
	    ...
	    try {
	        line=rd.readLine();
	        boolean  b = line.startsWith("success");
	        boolean a = line.startsWith("welcome");
	        boolean c= line.startsWith("Tap");
	        boolean d= line.startsWith("Open");
	    	if(b==true) {
	            total.append(line);
	            Intent goToNextActivity = new Intent(getApplicationContext(), UserAcc.class);
	    	...
	    	{
	    		total.append(line);
	    		Intent goToNextActivity = new Intent(getApplicationContext(), Admin.class);
	    		goToNextActivity.putExtra("username", u);
	    		//goToNextActivity.putExtra("lock", l);
	    		startActivity(goToNextActivity);
	    	}
	    	else if(d==true)
	    	{
	        ...
	        Toast.makeText(Login.this, "Stream Exception", Toast.LENGTH_SHORT).show();
	    }
